(function (window) {
    ...
    collectable.init = function (game) {
        ...
        // example: 
        collectable.create(type.steve, 400, 140, 0, 2);
        collectable.create(type.grace, 500, 140, 0, 2);
        collectable.create(type.max, 600, 140, 0, 2);
        collectable.create(type.db, 700, 150, 0, 2);
